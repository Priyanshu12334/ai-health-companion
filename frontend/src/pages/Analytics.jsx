...
const Analytics = () => {
 ...
 <h2 className="text-2xl font-bold flex items-center gap-2"><BarChart3 className="text-sky-600"/> Progress Analytics</h2>
 ...
 <div className="h-full flex items-center justify-center text-text-secondary">Not enough data to display</div>
 )}
 </div>
 </div>
